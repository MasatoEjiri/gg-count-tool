...
if "binary_threshold_value" not in st.session_state: 
    st.session_state.binary_threshold_value = 15 # ★★★ デフォルト値を15に変更 ★★★
...
if 'contour_color_name' not in st.session_state:
    st.session_state.contour_color_name = "緑" # デフォルトの色名を指定
...
if st.session_state.pil_image_to_process is not None:
    ...
    st.sidebar.radio(
        ...
        key="contour_color_name", # セッションステートキー
