...
if st.session_state.pil_image_to_process is not None:
        ...
        if 'contours' in locals() and contours: 
            for contour in contours:
                ...
                if min_area_to_use <= area <= max_area_to_use: 
                    ...
                    cv2.drawContours(output_image_contours, [contour], -1, (255,0,0), 2) # 青色固定
    ...
    if 'contours' in locals() and contours and binary_img_for_contours is not None and current_counted_spots > 0 :
