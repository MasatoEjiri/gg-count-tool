...
if uploaded_file is not None:
    ...
    threshold_value = st.sidebar.slider('二値化 閾値', 
                                min_value=0, max_value=255, value=88, step=1) 
    st.sidebar.caption("""
    ...
    if binary_img_for_contours is not None:
        ...
        if contours: # contours が None や空リストでないことを確認
    ...
    with col4:
        ...
        # contours 変数が定義されているか、また None でないかもチェックする
